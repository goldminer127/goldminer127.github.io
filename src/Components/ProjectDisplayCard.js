...
const ProjectLangBox = (props) => {
    ...
    useEffect(() => {
        if (value === 0) {
            ...
            if (!props.rerenderAnimationHandler.shouldNotPlayAnimation.includes("ProjectDisplayCard" + props.project.name)) {
                ...
                props.rerenderAnimationHandler.setShouldNotPlayAnimation("ProjectDisplayCard" + props.project.name)
            }
            else {
                loadBox.style.display = "none";
                displayBox.style.display = "block";
